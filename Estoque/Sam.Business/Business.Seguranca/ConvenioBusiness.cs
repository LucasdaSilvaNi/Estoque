...
{
    public class ConvenioBusiness : BaseBusiness, ICrudBaseBusiness<TB_CONVENIO>
    {

        #region Métodos Customizados

        public List<TB_CONVENIO> ListarConvenio()
        {
            //Exemplo para sort
            Expression<Func<TB_CONVENIO, int>> sort = a => a.TB_CONVENIO_ID;

            //Exemplo para Where
            Expression<Func<TB_CONVENIO, bool>> where = a => a.TB_CONVENIO_ID != 0;

            ConvenioInfrastructure persistencia = new ConvenioInfrastructure();
            var result = persistencia.SelectWhere(sort, true, where, this.SkipRegistros);
        ...
        public void Insert(TB_CONVENIO entity)
        {
            try
            {
                Consistir(entity);
                if (base.Consistido)
                {
                    ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Update(TB_CONVENIO entity)
        {
            try
            {
                Consistir(entity);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Delete(TB_CONVENIO entity)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
                ...
                //Atualiza o objeto
                entity = infraestrutura.SelectOne(a => a.TB_CONVENIO_ID == entity.TB_CONVENIO_ID);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void DeleteRelatedEntries(TB_CONVENIO entity)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        public void DeleteRelatedEntries(TB_CONVENIO entity, ObservableCollection<string> keyListOfIgnoreEntites)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        public TB_CONVENIO SelectOne(Expression<Func<TB_CONVENIO, bool>> where)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        public List<TB_CONVENIO> SelectAll()
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        /// <returns>Lista de objetos</returns>
        public List<TB_CONVENIO> SelectAll(Expression<Func<TB_CONVENIO, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_CONVENIO> SelectWhere(Expression<Func<TB_CONVENIO, bool>> where)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_CONVENIO> SelectWhere(Expression<Func<TB_CONVENIO, int>> sortExpression, bool desc, Expression<Func<TB_CONVENIO, bool>> where, int startRowIndex)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_CONVENIO> SelectWhere(Expression<Func<TB_CONVENIO, string>> sortExpression, bool desc, Expression<Func<TB_CONVENIO, bool>> where, int startRowIndex)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        public IQueryable<TB_CONVENIO> QueryAll()
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>IQueryable de objetos</returns>
        public IQueryable<TB_CONVENIO> QueryAll(Expression<Func<TB_CONVENIO, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Total de registros inteiro</returns>
        public int GetCount(Expression<Func<TB_CONVENIO, bool>> where)
        {
            try
            {
                ConvenioInfrastructure infraestrutura = new ConvenioInfrastructure();
        ...
        public void Consistir(TB_CONVENIO entity)
        {
            try
            {
                if (string.IsNullOrEmpty(entity.TB_CONVENIO_DESCRICAO))
                {
