...
{
    public class SerializacaoBusiness : BaseBusiness, ICrudBaseBusiness<TB_SERIALIZACAO>
    {
        ...
        public void Insert(TB_SERIALIZACAO entity)
        {
            try
            {
                Consistir(entity);
                if (base.Consistido)
                {
                    SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Update(TB_SERIALIZACAO entity)
        {
            try
            {
                Consistir(entity);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Delete(TB_SERIALIZACAO entity)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
                ...
                //Atualiza o objeto
                entity = infraestrutura.SelectOne(a => a.TB_SERIALIZACAO_ID == entity.TB_SERIALIZACAO_ID);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void DeleteRelatedEntries(TB_SERIALIZACAO entity)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        public void DeleteRelatedEntries(TB_SERIALIZACAO entity, ObservableCollection<string> keyListOfIgnoreEntites)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        public TB_SERIALIZACAO SelectOne(Expression<Func<TB_SERIALIZACAO, bool>> where)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        public List<TB_SERIALIZACAO> SelectAll()
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        /// <returns>Lista de objetos</returns>
        public List<TB_SERIALIZACAO> SelectAll(Expression<Func<TB_SERIALIZACAO, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_SERIALIZACAO> SelectWhere(Expression<Func<TB_SERIALIZACAO, bool>> where)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_SERIALIZACAO> SelectWhere(Expression<Func<TB_SERIALIZACAO, int>> sortExpression, bool desc, Expression<Func<TB_SERIALIZACAO, bool>> where, int startRowIndex)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_SERIALIZACAO> SelectWhere(Expression<Func<TB_SERIALIZACAO, string>> sortExpression, bool desc, Expression<Func<TB_SERIALIZACAO, bool>> where, int startRowIndex)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        public IQueryable<TB_SERIALIZACAO> QueryAll()
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>IQueryable de objetos</returns>
        public IQueryable<TB_SERIALIZACAO> QueryAll(Expression<Func<TB_SERIALIZACAO, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Total de registros inteiro</returns>
        public int GetCount(Expression<Func<TB_SERIALIZACAO, bool>> where)
        {
            try
            {
                SerializacaoInfrastructure infraestrutura = new SerializacaoInfrastructure();
        ...
        public void Consistir(TB_SERIALIZACAO entity)
        {
            try
            {
                //if (entity.TB_SERIALIZACAO_CODIGO == null)
                //{
                //    throw new Exception("O campo Código é de preenchimento obritagório");
                //}
                //if (string.IsNullOrEmpty(entity.TB_SERIALIZACAO_DESCRICAO))
                //{
