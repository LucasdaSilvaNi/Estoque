...
{
    public class MaterialBusiness : BaseBusiness, ICrudBaseBusiness<TB_MATERIAL>
    {
        ...
        public void Insert(TB_MATERIAL entity)
        {
            try
            {
                Consistir(entity);
                if (base.Consistido)
                {
                    MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Update(TB_MATERIAL entity)
        {
            try
            {
                Consistir(entity);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Delete(TB_MATERIAL entity)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
                ...
                //Atualiza o objeto
                entity = infraestrutura.SelectOne( a => a.TB_MATERIAL_ID == entity.TB_MATERIAL_ID);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void DeleteRelatedEntries(TB_MATERIAL entity)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        public void DeleteRelatedEntries(TB_MATERIAL entity, ObservableCollection<string> keyListOfIgnoreEntites)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        public TB_MATERIAL SelectOne(Expression<Func<TB_MATERIAL, bool>> where)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        public List<TB_MATERIAL> SelectAll()
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        /// <returns>Lista de objetos</returns>
        public List<TB_MATERIAL> SelectAll(Expression<Func<TB_MATERIAL, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_MATERIAL> SelectWhere(Expression<Func<TB_MATERIAL, bool>> where)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_MATERIAL> SelectWhere(Expression<Func<TB_MATERIAL, int >> sortExpression, bool desc, Expression<Func<TB_MATERIAL, bool>> where, int startRowIndex)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_MATERIAL> SelectWhere(Expression<Func<TB_MATERIAL, string>> sortExpression, bool desc, Expression<Func<TB_MATERIAL, bool>> where, int startRowIndex)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        public IQueryable<TB_MATERIAL> QueryAll()
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>IQueryable de objetos</returns>
        public IQueryable<TB_MATERIAL> QueryAll(Expression<Func<TB_MATERIAL, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Total de registros inteiro</returns>
        public int GetCount(Expression<Func<TB_MATERIAL, bool>> where)
        {
            try
            {
                MaterialInfrastructure infraestrutura = new MaterialInfrastructure();
        ...
        public void Consistir(TB_MATERIAL entity)
        {
            try
            {
                if (entity.TB_MATERIAL_CODIGO == null)
                {
                    throw new Exception("O campo Código é de preenchimento obritagório");
                }
                if (string.IsNullOrEmpty(entity.TB_MATERIAL_DESCRICAO))
                {
                    throw new Exception("O campo Descrição é de preenchimento obritagório");
                }
                if (entity.TB_CLASSE_MATERIAL_ID == null)
                {
                    throw new Exception("O campo Classe é de preenchimento obritagório");
                }
            }
            catch (Exception e)
            {
