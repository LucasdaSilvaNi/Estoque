...
{
    public class OrgaoBusiness : BaseBusiness, ICrudBaseBusiness<TB_ORGAO>
    {
        ...
        {
            OrgaoInfrastructure infra = new OrgaoInfrastructure();
            return infra.ListarOrgao();
        }

        public TB_ORGAO RecuperaOrgao(int orgaoId)
        {
            OrgaoInfrastructure infra = new OrgaoInfrastructure();
            return infra.RecuperaOrgao(orgaoId);
        }
        ...
        public void Insert(TB_ORGAO entity)
        {
            try
            {
                Consistir(entity);
                if (base.Consistido)
                {
                    OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Update(TB_ORGAO entity)
        {
            try
            {
                Consistir(entity);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Delete(TB_ORGAO entity)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
                ...
                //Atualiza o objeto
                entity = infraestrutura.SelectOne(a => a.TB_ORGAO_ID == entity.TB_ORGAO_ID);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void DeleteRelatedEntries(TB_ORGAO entity)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        public void DeleteRelatedEntries(TB_ORGAO entity, ObservableCollection<string> keyListOfIgnoreEntites)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        public TB_ORGAO SelectOne(Expression<Func<TB_ORGAO, bool>> where)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        public List<TB_ORGAO> SelectAll()
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        /// <returns>Lista de objetos</returns>
        public List<TB_ORGAO> SelectAll(Expression<Func<TB_ORGAO, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_ORGAO> SelectWhere(Expression<Func<TB_ORGAO, bool>> where)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_ORGAO> SelectWhere(Expression<Func<TB_ORGAO, int>> sortExpression, bool desc, Expression<Func<TB_ORGAO, bool>> where, int startRowIndex)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_ORGAO> SelectWhere(Expression<Func<TB_ORGAO, string>> sortExpression, bool desc, Expression<Func<TB_ORGAO, bool>> where, int startRowIndex)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        public IQueryable<TB_ORGAO> QueryAll()
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>IQueryable de objetos</returns>
        public IQueryable<TB_ORGAO> QueryAll(Expression<Func<TB_ORGAO, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Total de registros inteiro</returns>
        public int GetCount(Expression<Func<TB_ORGAO, bool>> where)
        {
            try
            {
                OrgaoInfrastructure infraestrutura = new OrgaoInfrastructure();
        ...
        public void Consistir(TB_ORGAO entity)
        {
            try
            {
                if (entity.TB_ORGAO_CODIGO == null)
                {
                    throw new Exception("O campo Código é de preenchimento obritagório");
                }
                if (string.IsNullOrEmpty(entity.TB_ORGAO_DESCRICAO))
                {
