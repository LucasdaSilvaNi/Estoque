...
{
    public class UoBusiness : BaseBusiness, ICrudBaseBusiness<TB_UO>
    {
        #region Métodos Customizados

        public IList<TB_UO> ListarOrgao(int OrgaoId)
        {
            UoInfrastructure infra = new UoInfrastructure();
            return infra.ListarOrgao(OrgaoId);
        }
        ...
        public void Insert(TB_UO entity)
        {
            try
            {
                Consistir(entity);
                if (base.Consistido)
                {
                    UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Update(TB_UO entity)
        {
            try
            {
                Consistir(entity);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void Delete(TB_UO entity)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
                ...
                //Atualiza o objeto
                entity = infraestrutura.SelectOne(a => a.TB_UO_ID == entity.TB_UO_ID);
        ...
        /// </summary>
        /// <param name="entity">Objeto</param>
        public void DeleteRelatedEntries(TB_UO entity)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        public void DeleteRelatedEntries(TB_UO entity, ObservableCollection<string> keyListOfIgnoreEntites)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        public TB_UO SelectOne(Expression<Func<TB_UO, bool>> where)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        /// <returns>Lista de objetos</returns>
        public List<TB_UO> SelectAll(Expression<Func<TB_UO, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_UO> SelectWhere(Expression<Func<TB_UO, bool>> where)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_UO> SelectWhere(Expression<Func<TB_UO, int>> sortExpression, bool desc, Expression<Func<TB_UO, bool>> where, int startRowIndex)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>Lista de objetos</returns>
        public List<TB_UO> SelectWhere(Expression<Func<TB_UO, string>> sortExpression, bool desc, Expression<Func<TB_UO, bool>> where, int startRowIndex)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        public IQueryable<TB_UO> QueryAll()
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        /// <param name="startRowIndex">índice da paginação</param>
        /// <returns>IQueryable de objetos</returns>
        public IQueryable<TB_UO> QueryAll(Expression<Func<TB_UO, object>> sortExpression, int maximumRows, int startRowIndex)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        /// <param name="where">Expressão lambda where</param>
        /// <returns>Total de registros inteiro</returns>
        public int GetCount(Expression<Func<TB_UO, bool>> where)
        {
            try
            {
                UoInfrastructure infraestrutura = new UoInfrastructure();
        ...
        public void Consistir(TB_UO entity)
        {
            try
            {
                if (entity.TB_UO_CODIGO == 0)
                {
                    throw new Exception("O campo Código é de preenchimento obritagório");
                }
                if (string.IsNullOrEmpty(entity.TB_UO_DESCRICAO))
                {
