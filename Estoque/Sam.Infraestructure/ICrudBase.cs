...
{
    public interface ICrudBase<E, C>
    {
        ...
        List<E> SelectAll(Expression<Func<E, object>> sortExpression, int startRowIndex);
        ...
        IQueryable<E> QueryAll(Expression<Func<E, object>> sortExpression, int startRowIndex);
