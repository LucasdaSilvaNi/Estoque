...
namespace Sam.Integracao.SIAF.ClientWS
{
    public class WsClient
    {
        ...
        private Assembly createWSClientAssembly(string webServiceAsmxUrl)
        {
            ...
            initiateSSLTrust();
            //if (webServiceAsmxUrl.Contains("siafemhom.intra.fazenda.sp.gov.br") || webServiceAsmxUrl.ToLowerInvariant().Contains(@"/localhost") || !webServiceAsmxUrl.Contains("www6.fazenda.sp.gov.br"))
