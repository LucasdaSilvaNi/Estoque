<%@ Page Language="C#" MasterPageFile="~/MasterPage/PrincipalFull.Master" AutoEventWireup="true"
    EnableEventValidation="true" CodeBehind="ConsumoImediato.aspx.cs" ValidateRequest="false" Inherits="Sam.Web.Almoxarifado.ConsumoImediato"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    ...
    <script type="text/javascript">
        ...
        function calcularPrecoUnitario() {
            ...
            var qtd = 1.000;
            var precoUnit = document.getElementById("ctl00_cphBody_txtPrecoUnit") == null ? 0 : document.getElementById("<%=txtPrecoUnit.ClientID%>").value;
            ...
            if (valTotal != null) {
                ...
                if (nomeee != "2") {
                    ...
                    if (qtd == toFixed(0, numCasasDecimais_QtdeItem) || valTotal == toFixed(0, 2))
                        precoUnit = toFixed(0, numCasasDecimais_ValorUnitario);
                    if(document.getElementById('<%= txtPrecoUnit.ClientID %>') != null)
                ...
                if (toFixedSupportEnable) {
                    ...
                    if(document.getElementById("<%=txtQtdeMov.ClientID%>") != null)
    ...
    <div id="content">
        ...
        <asp:UpdatePanel runat="server" ID="updAjax">
            <ContentTemplate>
                <h1>Módulo - Almoxarifado - Consumo Imediato</h1>
                <div class="formulario">
                                ...
                                <fieldset class="sideLeftEntrada1">
                                    ...
                                    <p>
                                        <asp:RadioButtonList ID="rblTipoMovimento" runat="server" AutoPostBack="true" DataTextField="Descricao"
                                            ...
                                            style = "width: 445px; margin: 0px auto;" onclick="ShowInformation();">
                                        </asp:RadioButtonList>
                                    </p>
                                </fieldset>
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td style="padding-right: 10px">
                                                        <asp:TextBox ID="txtInfoSiafemCE" runat="server" MaxLength="22" Style="float: left !important; font-size: 12px" Enabled="false" />
                                                    </td>
                                                    <td>
                    ...
                    <p runat="server" id="divUge">
                        <asp:Label ID="Label5" runat="server" class="labelFormulario" Width="100px" Text="UGE*:" Font-Bold="true" />
                        <asp:DropDownList runat="server" ID="ddlUGE" Width="70%" AutoPostBack="True" DataTextField="CodigoDescricao" DataValueField="Id" OnSelectedIndexChanged="ddlUGE_SelectedIndexChanged" />
                        <asp:TextBox ID="txtCodFornecedor" runat="server" Visible="false" Width="70%" />
                    </p>
                    <p runat="server" id="divUa">
                        <asp:Label ID="Label3" runat="server" class="labelFormulario" Width="100px" Text="UA:" Font-Bold="true" />
                        <asp:DropDownList runat="server" ID="ddlUA" Width="70%" DataTextField="CodigoDescricao" DataValueField="Id" OnSelectedIndexChanged="ddlUA_SelectedIndexChanged" AutoPostBack="true" />
                    ...
                    <p id="idEmpenho" runat="server">
                        ...
                        <asp:Button ID="btnListarEmpenhos" runat="server" Text="Listar Empenhos" CssClass=""
                            OnClick="btnListarEmpenhos_Click" Style="position: static; margin-top: -22px; width: 120px !important" />
                    </p>
                    <p id="idPTres" runat="server">
                        <table>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlPTResAcao" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPTResAcao_SelectedIndexChanged" Width="150px" />
                                </td>
                                <td>
                                    <asp:Label ID="lblIndicadorPTRes" runat="server" CssClass="labelFormulario" Style="width: 50px !important"
                                        Text="PTRes:" /></td>
                                <td>
                                    <asp:DropDownList ID="ddlPTResItemMaterial" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlPTResItemMaterial_SelectedIndexChanged" Width="150px" />
                                </td>
                                <td>
                                    <asp:Label ID="lblIndicadorDescricaoPTRes" runat="server" Font-Bold="true" Style="font-weight: bold; font-size: 0.9em; width: 300px !important; margin-left: 10px"
                                        Text="Descrição:"
                                        Visible="true" /></td>
                                <td>
                                    <asp:TextBox ID="txtDescricaoPTRes" runat="server" Enabled="false" Style="height: 20px; line-height: 22px;"
                                        Visible="true" Width="400px" /></td>
                            </tr>
                        </table>
                    </p>
                    <p id="idOrgaoTransf" visible="false" runat="server" style="padding-right: 10px">
                        <asp:Label ID="lblOrgao" runat="server" CssClass="labelFormulario" Width="100px" Text="Orgão:"
                            Font-Bold="True" />
                        <asp:TextBox ID="txtOrgao_Transferencia" Width="500px" runat="server"></asp:TextBox>
                    </p>
                    ...
                    <p id="idDocumento">
                        ...
                        <asp:TextBox ID="txtDocumentoAvulso" runat="server" MaxLength="8" CssClass="inputFromNumero"
                            Width="120px" Style="display: inline-block; font-weight: bold; width: 500px; height: 20px" />
                            ...
                            <HeaderTemplate>
                                <table width="100%" border="1" cellpadding="0" cellspacing="0" class="tabela">
                                    <tr id="celHeaderEmpenho" runat="server" style="display: none">
                                        <th colspan="6" id="HeaderDadosEmpenho" runat="server">DADOS DO EMPENHO
                                        </th>
                                        <th colspan="2">DADOS DO SAM
                                        </th>
                                        <th colspan="2">DADOS DA ENTRADA
                                        </th>
                                    </tr>
                                    <tr class="corpo">
                                        <th rowspan="2" align="center" width="1%" id="hdrLiquidar" runat="server" style="display: none">Liquidar
                                        </th>
                                        ...
                                        <th rowspan="1" width="4%" id="celHdrQuant" runat="server" style="display: none">Valor Unit.
                                        </th>

                                        <th rowspan="1" width="8%">Subitem
                                        </th>
                                        ...
                                        <th rowspan="1" width="6%" id="hdrQtdRecSubitem" runat="server" style="visibility: hidden; display: none">
                                            <asp:Label ID="lblQtdRecSubitem" runat="server" Text="Qtd. Rec. Subitem"></asp:Label>
                                        </th>
                                        <th rowspan="1" width="7%" style="visibility: hidden; display: none">
                                            <asp:Label ID="lblPrecoUnit" runat="server" Text="Preço Unit."></asp:Label>
                                        </th>
                                        <th rowspan="1" width="7%" id="hdrPrecoTotal" runat="server">Vl. Total
                                        </th>
                                        <th rowspan="1" width="7%" id="hdrPrecoUnitSAM" style="display: none;" runat="server">Preço Unitário SAM
                                        </th>
                                        <th rowspan="1" width="7%" id="hdrSaldoLiquidar" runat="server">
                                            <asp:Label ID="Label1" runat="server" Text="Valor a Liquidar"></asp:Label>
                                        </th>
                                        <th rowspan="2" width="5%" id="hdrEdit" runat="server">Editar
                                        </th>
                                    </tr>
                                    <tr class="corpo">
                                        <th width="4%" id="hdr2QtdLiq1x" runat="server" style="display: none;">SIAFEM
                                        </th>
                                        <th width="4%" id="hdr2QtdLiq2" runat="server">Entrada
                                        </th>
                                    </tr>
                            </HeaderTemplate>
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td align="center" id="celQtdeMov" runat="server" style="visibility: hidden; display: none">
                                    ...
                                    <td align="center" id="celPrecoUnit" runat="server" style="visibility: hidden; display: none">
                                    ...
                                    <td align="center" id="celValorItemEmpenho" runat="server">
                                        <%--<asp:Label ID="lblSaldoLiq" runat="server" Text='<%#  String.Format("{0:0.00}",DataBinder.Eval(Container.DataItem, "SaldoLiq") )%>'></asp:Label>--%>
                                        <asp:TextBox ID="txtValorItemEmpenho" runat="server" Text='<%#  String.Format("{0:#,##0.00}",DataBinder.Eval(Container.DataItem, "ValorMov") )%>' onkeypress='return SomenteNumeroDecimal(event)' OnTextChanged="txtValorItemEmpenho_OnTextChanged" AutoPostBack="true" />
                                        <asp:HiddenField ID="hdfValorLiqGrid" runat="server" Value='<%#DataBinder.Eval(Container.DataItem, "ValorMov")%>' />
                                    </td>
                                ...
                                <tr class="odd" id="tblLote2" runat="server">

                                    <td colspan="4" id="Td1" runat="server"></td>
                                </tr>
                                <tr class="odd" id="tblLote" runat="server" style="background-color: White !important">
                                    <td colspan="4" id="celTdEmpenho" runat="server" style="display: none"></td>
                                    <td colspan="2">
                                        ...
                                        <table style="float: left" cellpadding="0" border="0" cellspacing="0">
                                            ...
                                            <tr runat="server" id="trEmpenhoLoteNovo" visible="false">
                                                <td colspan="6">
                                                    <table>
                                                        <tr>
                                                            <td>EMPENHO<sup style="font-size: smaller">(1)</sup>
                                                            </td>
                                                            <td>SAM<sup style="font-size: smaller">(2)</sup>
                                                            </td>
                                                            <td>Nº do Lote
                                                            </td>
                                                            <td>Vcto
                                ...
                                <tr>
                                    <td colspan="15" align="left" id="rowDescricao" runat="server">
                    ...
                    <p class="botaoLeft" id="divBotaoInsereItem" runat="server">
                        <asp:Button ID="btnNovo" runat="server" Text="Adicionar Item" SkinID="Btn100" style="width:100px;margin-left:10px;" OnClick="btnNovo_Click" Visible="false" />
                    </p>
                    <br />
                        ...
                        <div id="interno">
                            <div>
                                <fieldset class="fieldset">
                                    <br />
                                    <p id="prCampoInfoIndicativoUsoLote" runat="server" visible="false">
                                    ...
                                    <p>
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label15" runat="server" CssClass="labelFormulario" Width="100px" Text="Subitem:" Font-Bold="true" />
                                                </td>
                                                <td>
                                                    <asp:Panel runat="server" ID="pnlDefaulButton" DefaultButton="btnCarregarSubItem" Style="text-align: left; border: 0">
                                                        <asp:TextBox ID="txtSubItem" class="txtSubItem" runat="server" MaxLength="12" size="12" onblur="return preencheZeros(this,'12')" onkeypress="return SomenteNumero(event)" />
                                                        <asp:ImageButton ID="imgSubItemMaterial" ClientIDMode="Static" ImageUrl="../Imagens/lupa.png" OnClientClick="OpenModalItem();" CssClass="basic" ToolTip="Pesquisar" runat="server" />
                                                        <asp:HiddenField ID="idSubItem" runat="server" />
                                                        <asp:HiddenField ID="idSubItemOld" runat="server" />
                                                        <asp:Button runat="server" ID="btnCarregarSubItem" OnClick="btnCarregarSubItem_Click" Width="0px" />
                                                    </asp:Panel>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <p id="divQtdLiq" runat="server" visible="false">
                                        <asp:Label ID="Label10" runat="server" CssClass="labelFormulario" Font-Bold="True" Text="Qtd. a Liquid.:" Width="100px" Visible="false" />
                                        <asp:TextBox ID="txtQtdeLiq" runat="server" Enabled="False" MaxLength="10" onkeypress="return SomenteNumero(event)" Width="150px" />
                                    </p>
                                    <p id="divQtdMov" runat="server" visible="false">
                                        <asp:Label ID="lblCampoInfoQtdeAEntrar" runat="server" CssClass="labelFormulario" Font-Bold="true" Text="Qtd. a Entrar:" Width="100px" />
                                        <asp:TextBox ID="txtQtdeMov" runat="server" MaxLength="20" onkeypress="return SomenteNumero(event)" Width="150px" />
                                    </p>
                                    <p id="divPrecoUnitario" runat="server" visible="false">
                                        <asp:Label ID="lblCampoInfoPrecoUnitario" runat="server" CssClass="labelFormulario" Font-Bold="true" Text="Preço Unit.:" Width="100px" />
                                        <asp:TextBox ID="txtPrecoUnit" runat="server" BackColor="#CCCCCC" CssClass="numerico" MaxLength="20" onkeypress="return SomenteNumeroDecimal(event)" Width="150px" />
                                    </p>
                                    <p>
                                        <asp:Label ID="Label4" runat="server" CssClass="labelFormulario" Font-Bold="true" Text="Valor Total:" Width="100px" />
                                        <asp:TextBox ID="txtValorMovItem" runat="server" CssClass="numerico" MaxLength="20" onkeypress="return SomenteNumeroDecimal(event)" Width="150px" />
                                    </p>
                                    <p>
                                        <asp:Label ID="Label12" runat="server" CssClass="labelFormulario" Font-Bold="true" Text="Unidade:" Width="100px" />
                            ...
                            <div class="botao">
                                <div class="DivButton">
                                    <p class="botaoLeft">
                                        <asp:Button ID="btnGravarItem" CssClass="" runat="server" Text="Adicionar" OnClick="btnGravarItem_Click" Visible="true" />
        ...
        <div id="dialogInfo" title="Atenção!">
            ...
            <p class="infoMsg">
                ...
                <br />
                Preste atenção na natureza de despesa do mesmo.
            </p>
        </div>
        <div id="log">
        </div>
