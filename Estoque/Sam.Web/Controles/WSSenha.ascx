...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WSSenha.ascx.cs" Inherits="Sam.Web.Controles.WSSenha" %>
    ...
    <ContentTemplate>
        ...
        <p>
            ...
            <p style="text-align:center">
                <asp:Button ID="btnOKSenha" runat="server" onclick="btnOKSenha_Click" 
                    Text="OK" />
                <asp:Button ID="btnCancelarSenha" runat="server" 
                    onclick="btnCancelarSenha_Click" OnClientClick="CloseModalSenhaWs();" 
                    Text="Cancelar" />
            </p>
        </p>
        </div>
