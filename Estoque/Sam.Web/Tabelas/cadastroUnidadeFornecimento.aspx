<%@ Page Title="Módulo Tabelas :: Catálogo :: Unidades de Fornecimento" Language="C#" MasterPageFile="~/MasterPage/PrincipalFull.Master" AutoEventWireup="true" CodeBehind="cadastroUnidadeFornecimento.aspx.cs" Inherits="Sam.Web.Seguranca.cadastroUnidadeFornecimento"
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">
    <div id="content">
        <h1>
            Módulo Tabelas - Catálogo - Unidades de Fornecimento</h1>
          ...
          <div id="Div3">
            <p>
                ...
                <asp:ObjectDataSource ID="sourceListaOrgao" runat="server" OldValuesParameterFormatString="original_{0}"
                    ...
                    TypeName="Sam.Presenter.UnidadeFornecimentoPresenter">
        ...
        <asp:GridView ID="gridUnidade" runat="server" AllowPaging="True"  
            OnSelectedIndexChanged="gridUnidade_SelectedIndexChanged">
            <Columns>
                ...
                <asp:BoundField DataField="Codigo" HeaderText="Cód." ItemStyle-Width="50px" DataFormatString="{0:D12}">
