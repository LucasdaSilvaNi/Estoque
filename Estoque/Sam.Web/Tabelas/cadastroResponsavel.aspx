<%@ Page Title="Módulo Tabelas :: Estrutura Organizacional :: Responsável" Language="C#" MasterPageFile="~/MasterPage/PrincipalFull.Master" AutoEventWireup="true" CodeBehind="cadastroResponsavel.aspx.cs" Inherits="Sam.Web.Seguranca.cadastroResponsavel"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
        <div id="content">
        <h1>
            Módulo Tabelas - Estrutura Organizacional - Responsável</h1>
        <asp:UpdatePanel runat="server" ID="udpGeral">
        <ContentTemplate>   
        <fieldset class="fieldset">
            <div id="Div3">
                <p>
                    <asp:Label ID="Label2" runat="server" CssClass="labelFormulario" Width="100px" Text="Órgão*:" Font-Bold="true"></asp:Label>
        ...
        <br />
        <asp:GridView ID="gridResponsavel" runat="server" AllowPaging="True" OnSelectedIndexChanged="gridResponsavel_SelectedIndexChanged">
            <Columns>
                <asp:TemplateField ShowHeader="False" Visible="false">
                    <ItemTemplate>
                        ...
                        <asp:Label ID="lblCargo" runat="server" Text='<%# Eval("Cargo") %>' Visible="false"></asp:Label>
                        <asp:Label ID="lblEndereco" runat="server" Text='<%# Eval("Endereco") %>' Visible="false"></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="Codigo" HeaderText="Cód." ItemStyle-Width="50px" DataFormatString="{0:D11}">
        ...
        <asp:ObjectDataSource ID="sourceGridResponsavel" runat="server"
            SelectMethod="PopularDadosResponsavel" 
            TypeName="Sam.Presenter.ResponsavelPresenter" EnablePaging="True" 
                ...
                <div>
                    <fieldset class="fieldset">
                        <p>
                            ...
                            <asp:TextBox ID="txtCodigo" MaxLength="11"
                                runat="server" size="12"></asp:TextBox>
                        </p>
                        <p>
                            <asp:Label ID="Label1" runat="server" class="labelFormulario" Width="100px" Text="Descrição*:"></asp:Label>
                            <asp:TextBox ID="txtDescricao" runat="server" MaxLength="60" size="60" 
                                Width="80%"></asp:TextBox>
                        </p>
                        <p>
                            <asp:Label ID="Label4" runat="server" class="labelFormulario" Width="100px" Text="Cargo*:"></asp:Label>
                            <asp:TextBox ID="txtCargo" runat="server" MaxLength="30" size="30" 
                                Width="300px"></asp:TextBox>
                        </p>
                        <p>
                            <asp:Label ID="Label5" runat="server" class="labelFormulario" Width="100px" Text="Endereço*:"></asp:Label>
                            <asp:TextBox ID="txtEndereco" runat="server" MaxLength="40" size="40" 
                                Width="80%"></asp:TextBox>
                        </p>
                    </fieldset>
                </div>
