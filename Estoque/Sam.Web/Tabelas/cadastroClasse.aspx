<%@ Page Language="C#" MasterPageFile="~/MasterPage/PrincipalFull.Master" AutoEventWireup="true"
    CodeBehind="cadastroClasse.aspx.cs" Inherits="Sam.Web.Seguranca.cadastroClasse"
    Title="Módulo Tabelas :: Catálogo :: Classe" %>

<%@ Register src="../Controles/ListInconsistencias.ascx" tagname="ListInconsistencias" tagprefix="uc1" %>
<asp:Content ID="Content2" ContentPlaceHolderID="cphBody" runat="server">

<div id="content">
        <h1>Módulo Tabelas - Catálogo - Classes de Material</h1>
 <asp:UpdatePanel runat="server" ID="udpGeral">
 <ContentTemplate>
 <div style="margin-bottom:20px; margin-top:20px">
  <fieldset class="fieldset">
   <p>
  <asp:Label ID="Label2" runat="server" CssClass="labelFormulario" Width="100px" Text="Grupo*:" Font-Bold="true"></asp:Label>
    <asp:DropDownList runat="server" ID="ddlGrupo" Width="80%" AutoPostBack="True" TabIndex="0"
    ...
    <asp:GridView ID="gridClasse" runat="server" HeaderStyle-CssClass="ProdespGridViewHeaderStyleClass"
        DataKeyNames="Id" AutoGenerateColumns="False" AllowPaging="True" OnPageIndexChanged="gridClasse_PageIndexChanged"
        OnSelectedIndexChanged="gridClasse_SelectedIndexChanged" CssClass="tabela">
    ...
    <asp:ObjectDataSource ID="sourceGridClasse" runat="server" SelectMethod="PopularDadosClasse"
        TypeName="Sam.Presenter.ClassePresenter" EnablePaging="True" MaximumRowsParameterName="maximumRowsParameterName"
        SelectCountMethod="TotalRegistros" StartRowIndexParameterName="startRowIndexParameterName"
        OldValuesParameterFormatString="original_{0}">
        <SelectParameters>
            <asp:Parameter Name="startRowIndexParameterName" Type="Int32" />
            <asp:Parameter Name="maximumRowsParameterName" Type="Int32" />
            <asp:ControlParameter ControlID="ddlGrupo" DefaultValue="0" Name="_grupoId" 
     ...
     <br />
      <div id="interno">
            <div>
                <fieldset class="fieldset">
                    <p>
                        <asp:Label ID="codigo" runat="server" class="labelFormulario" Width="100px" Text="Classe*:" />
                        <asp:TextBox ID="txtCodGrupo" MaxLength="2" runat="server" size="2" Enabled="false" />
                        <asp:TextBox ID="txtCodigo" CssClass="inputFromNumero" MaxLength="2" runat="server" size="2" onblur="preencheZeros(this,'2')" />
                    </p>
                    <p>
