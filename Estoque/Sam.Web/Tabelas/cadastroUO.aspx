<%@ Page Language="C#" MasterPageFile="~/MasterPage/PrincipalFull.Master" AutoEventWireup="true"
    CodeBehind="cadastroUO.aspx.cs" Inherits="Sam.Web.Seguranca.cadastroUO"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div id="content">
        <h1>Módulo Tabelas - Estrutura Organizacional - UO</h1>
        <asp:UpdatePanel runat="server" ID="udpGeral">
            <ContentTemplate>
                ...
                <br />
                <asp:GridView ID="gridUO" runat="server" AllowPaging="True" OnSelectedIndexChanged="gridUO_SelectedIndexChanged">
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Descrição">
                            <ItemTemplate>
                                <asp:Label ID="lblDescricaoUO" runat="server" Text='<%# Convert.ToString(Eval("Descricao")) + (Convert.ToBoolean(Eval("Ativo"))==true ?  "" : " (Inativa)") %>'>                                  
                                </asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:ObjectDataSource ID="sourceGridUO" runat="server"
                    SelectMethod="PopularDadosUO"
                    ...
                    <div id="interno">
                        <div>
                            <fieldset class="fieldset">
                                ...
                                <p>
                                    <asp:Label ID="Label10" runat="server" CssClass="labelFormulario" Width="100px" Text="Status*:"></asp:Label>
