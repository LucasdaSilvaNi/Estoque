<%@ Page Title="Módulo Tabelas :: Estrutura Organizacional :: Centro de Custos" Language="C#" MasterPageFile="~/MasterPage/PrincipalFull.Master" AutoEventWireup="true" CodeBehind="cadastroCentroCusto.aspx.cs" Inherits="Sam.Web.Seguranca.cadastroCentroCusto"
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphBody" runat="server">
    <div id="content">
        <h1>
            Módulo Tabelas - Estrutura Organizacional - Centro de Custos</h1>
        ...
        <br />
        <asp:GridView ID="gridCentroCusto" runat="server" AllowPaging="True" OnSelectedIndexChanged="gridCentroCusto_SelectedIndexChanged">
            <Columns>
        ...
        <asp:ObjectDataSource ID="sourceGridCentroCusto" runat="server"
            SelectMethod="PopularDadosCentroCusto" 
            TypeName="Sam.Presenter.CentroCustoPresenter" EnablePaging="True" 
                ...
                <div>
                    <fieldset class="fieldset">
                        <p>
                            ...
                            <asp:TextBox ID="txtCodigo" MaxLength="22"
                                runat="server" size="22" Width="158px"></asp:TextBox>
                        </p>
                        <p>
